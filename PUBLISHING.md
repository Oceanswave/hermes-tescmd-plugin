...
2. verifies the tag name matches `project.version` in `pyproject.toml` (`v0.5.0a12` or `0.5.0a12` are accepted)
...
```bash
gh release create v0.5.0a12 --title "v0.5.0a12" --generate-notes --prerelease
```
