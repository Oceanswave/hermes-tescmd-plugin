...
2. verifies the tag name matches `project.version` in `pyproject.toml` (`v0.5.0a13` or `0.5.0a13` are accepted)
...
```bash
gh release create v0.5.0a13 --title "v0.5.0a13" --generate-notes --prerelease
```
