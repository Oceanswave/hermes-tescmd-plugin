...
2. verifies the tag name matches `project.version` in `pyproject.toml` (`v0.5.0a22` or `0.5.0a22` are accepted)
...
```bash
gh release create v0.5.0a22 --title "v0.5.0a22" --generate-notes --prerelease
```
