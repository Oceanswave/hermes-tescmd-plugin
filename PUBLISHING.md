...
2. verifies the tag name matches `project.version` in `pyproject.toml` (`v0.5.0a16` or `0.5.0a16` are accepted)
...
```bash
gh release create v0.5.0a16 --title "v0.5.0a16" --generate-notes --prerelease
```
