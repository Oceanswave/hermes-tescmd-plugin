...
2. verifies the tag name matches `project.version` in `pyproject.toml` (`v0.5.0a21` or `0.5.0a21` are accepted)
...
```bash
gh release create v0.5.0a21 --title "v0.5.0a21" --generate-notes --prerelease
```
