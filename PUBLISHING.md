...
2. verifies the tag name matches `project.version` in `pyproject.toml` (`v0.5.0a11` or `0.5.0a11` are accepted)
...
```bash
gh release create v0.5.0a11 --title "v0.5.0a11" --generate-notes --prerelease
```
