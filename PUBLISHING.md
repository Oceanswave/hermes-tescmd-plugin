...
2. verifies the tag name matches `project.version` in `pyproject.toml` (`v0.5.0a14` or `0.5.0a14` are accepted)
...
```bash
gh release create v0.5.0a14 --title "v0.5.0a14" --generate-notes --prerelease
```
